...
;;; --------------------------------------------------
;;; hide show keys
(define-key ergoemacs-keymap ergoemacs-hs-show-all 'hs-show-all)
(define-key ergoemacs-keymap ergoemacs-hs-show-block 'hs-show-block)
(define-key ergoemacs-keymap ergoemacs-hs-hide-all 'hs-hide-level)
(define-key ergoemacs-keymap ergoemacs-hs-hide-block 'hs-hide-block)
