...
;;; $Id: windows.el,v 2.42 2008/05/13 01:21:09 yuuji Exp $
;;; (c) 1993-2008 by HIROSE Yuuji [yuuji@gentei.org]
;;; Last modified Mon May 12 23:08:01 2008 on firestorm
	...
	(cond
	 ...
	 ((and (fboundp 'delete-frame) (null window-system)
	  ...
	  (save-window-excursion
	    (set-window-configuration (aref win:configs n))
  ...
  (cond
   ...
   (t					;NOT use-frame
    ...
    (and (null window-system)
	 ...
	 (select-frame
	  (make-frame (list (cons 'name (format "windows:%d" to))))))))
...
;;
;; Revision 2.41  2007/06/06 11:29:29  yuuji
